...
<div class="container"> 
  ...
  <div class="alert alert-error"> <strong>Hmm, </strong> that doesn't look like a valid id/password.  Try again? </div>
  <?
  ...
  <div class="alert alert-error"> You must log in to use this service. </div>
  <?
                  }
              ?>
  <div class="main-form"> <img src="images/blazer.gif" width="90" style="position:relative; top:30px; left:-90px;"/>
...
<div class="adm-link" style="position:absolute; bottom: 2px; left: 2px;"> <a href="http://tutors.mbhs.edu/lhc/index.php/site_admin/user/login">Admin</a> </div>
</body>
</html>